...
public class SelControlAdapter extends BaseAdapter {
	...
	public SelControlAdapter(Context context, ArrayList<Control> control) {
		mContext = context;
		this.list = control;
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		control_tv.setTextColor(Color.BLACK);
